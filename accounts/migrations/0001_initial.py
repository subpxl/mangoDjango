...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.ImageField(blank=True, default='/images/default-cover.PNG', null=True, upload_to='users/cover_photos')),
                ('cover_photo', models.ImageField(blank=True, default='/images/default-profile.PNG', null=True, upload_to='users/profile_pictures')),
